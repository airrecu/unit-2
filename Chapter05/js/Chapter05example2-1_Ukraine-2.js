...
function calculateMinValue(data){
    ...
    var allValues = [];
    //loop through each oblast
    for(var oblast of data.features){
        //loop through each year
        for(var year = 1985; year <= 2015; year+=5){
              //get population for current year
              var value = oblast.properties["Pop_"+ String(year)];
              //add value to array
...
function pointToLayer(feature, latlng){
    ...
    var popupContent = "<p><b>Region:</b> " + feature.properties.Oblast //+ "</p><p><b>" + attribute + ":</b> " + feature.properties[attribute] + "</p>";
